...
window.MERIDIAN_DATA = {
  artworks: [
    { title: "Silent Dialogue", artist: "Nadia El Masry", medium: "Acrylic & gold leaf on canvas", size: "135 × 90 cm", year: "2026", image: "assets/artwork-1.jpg" },
    { title: "Field Notes", artist: "Karim Abdel Noor", medium: "Mixed media on linen", size: "100 × 70 cm", year: "2025", image: "assets/artwork-2.jpg" },
    { title: "Bird of Passage", artist: "Mina Fahmy", medium: "Bronze sculpture", size: "42 × 24 × 18 cm", year: "2024", image: "assets/artwork-3.jpg" },
    { title: "Blue Commute", artist: "Lina Mourad", medium: "Acrylic on canvas", size: "110 × 80 cm", year: "2026", image: "assets/artwork-4.jpg" },
  ],
  artists: [
...
window.renderArtworks = function (el) {
  if (!el) return;
  el.innerHTML = window.MERIDIAN_DATA.artworks.map((a) => `
